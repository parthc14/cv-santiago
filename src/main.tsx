...
console.log('%c Designing scalable systems. Let\'s solve something hard → parthchitroda@gmail.com ', 'background: #f97316; color: #1a1a1a; font-size: 13px; font-weight: bold; padding: 4px 8px; border-radius: 3px;')

// Debug API for technical recruiters — type window.__parth in console
Object.defineProperty(window, '__parth', {
  value: Object.freeze({
    ...
    hire_me: 'parthchitroda@gmail.com',
  }),
  configurable: false,
})
        ...
        <Suspense fallback={null}>
          <Routes>
            ...
            {articleRegistry.map((article) => {
              ...
              return <Route key={`${article.id}-en`} path={`/${article.slugs.en}`} element={<ArticleComponent lang="en" />} />
            })}
