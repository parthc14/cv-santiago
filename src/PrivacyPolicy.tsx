    ...
    sections: [
      {
        ...
        items: [
          'Mensajes del chatbot: cuando interactuas con el chatbot de Parth, los mensajes se procesan para generar respuestas. No se solicita ni almacena informacion personal identificable.',
      ...
      },
      {
        ...
        items: [
          'Los mensajes del chatbot se utilizan exclusivamente para generar respuestas contextuales sobre la experiencia profesional de Parth.',
    ...
    sections: [
      {
        ...
        items: [
          'Chatbot messages: when you interact with Parth chatbot, messages are processed to generate responses. No personally identifiable information is requested or stored.',
      ...
      },
      {
        ...
        items: [
          "Chatbot messages are used exclusively to generate contextual responses about Parth's professional experience.",
